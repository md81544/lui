...
Ui::Ui(std::string_view argv0)
{
    ...
    m_menu->addItem(static_cast<int>(MenuItem::Define), "d_Efine");
    m_hotkeys.add('e', hotkeys::Type::Menu, CommandType::Define);
    m_hotkeys.add('E', hotkeys::Type::Global, CommandType::Define);
    m_menu->addNewLine();
